...
// Components
import WhyHostsBanner from "./WhyHostsBanner";
import WhyBlock from "../../components/WhyHost/WhyBlock/WhyBlock";
    ...
    if (loading) {
      ...
      return (
        <div className="whyhost-content">
          <WhyHostsBanner data={settingsCollection} />
