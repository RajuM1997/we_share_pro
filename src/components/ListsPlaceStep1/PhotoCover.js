          ...
          <Col xs={12} sm={7} md={7} lg={7} className={s.landingContent}>
            <div>
              <h3 className={s.landingContentTitle}>
                <FormattedMessage {...messages.setCoverPhoto} />
              </h3>
                            ...
                            <div className={s.listPhotoCover}>
                              ...
                              <div className={s.coverPhotoSelection}>
                                <Field
                                  ...
                                  value={option.id}
                                  checked={
                                    coverPhoto == option.id ? true : false
                                  }
                                />
                                <span>
                                  {" "}
                                  <FormattedMessage {...messages.coverLabel} />
                                </span>
                              </div>
                            </div>
                          </div>
...
export default injectIntl(
  withStyles(s, bt)(connect(mapState, mapDispatch)(PhotoCover))
);
