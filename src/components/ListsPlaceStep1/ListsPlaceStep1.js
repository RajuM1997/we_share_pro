  ...
  render() {
    ...
    return (
      <div className={"inputFocusColor"}>
        ...
        {currentPage === "bedrooms" && (
          <Page3 nextPage={this.nextPage} previousPage={this.previousPage} />
        )}
        {currentPage === "bathrooms" && (
          <Page4 nextPage={this.nextPage} previousPage={this.previousPage} />
        )}
        ...
        {currentPage === "spaces" && (
          <Page8 previousPage={this.previousPage} onSubmit={update} />
        )}
        ...
        {currentPage === "review-how-guests-book" && (
          <ReviewGuestBook
            previousPage={this.previousPage}
            nextPage={this.nextPage}
          />
        ...
        {currentPage === "discount" && (
          <Discount previousPage={this.previousPage} nextPage={this.nextPage} />
        )}
        {currentPage === "booking-scenarios" && (
          <Booking previousPage={this.previousPage} nextPage={this.nextPage} />
        )}
        {currentPage === "local-laws" && (
          <LocalLaws previousPage={this.previousPage} onSubmit={updateStep3} />
        )}
      </div>
    );
  }
