...
import {
  startSmallHomeBannerUploaderLoader,
  endSmallHomeBannerUploaderLoader,
} from "../../../../actions/siteadmin/manageSmallBannerImage";
import { maxUploadSize } from "../../../../config";

class Dropzone extends Component {
  static propTypes = {
    startSmallHomeBannerUploaderLoader: PropTypes.any.isRequired,
    endSmallHomeBannerUploaderLoader: PropTypes.any.isRequired,
  };
  ...
  async success(file, fromServer) {
    const { doUploadHomeBanner, change } = this.props;
    ...
    await change("AddBanner", "small_image", fileName);
  }
