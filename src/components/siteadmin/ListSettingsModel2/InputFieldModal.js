...
// Component
import InputFieldForm from "../NewListSettingsForm/InputFieldForm";

class InputFieldModal extends Component {
  static propTypes = {
...
export default withStyles(s)(connect(mapState, mapDispatch)(InputFieldModal));
