  ...
  title(data) {
    if (data) {
      if (data.title != null) {
        ...
        return (
          data?.settingsData[0]?.listsettings?.itemName + " in " + data.city
        );
      }
    }
  }
        ...
        <li className={s.panelBody}>
          <Row>
            <Col
              xs={12}
              sm={12}
              className={cx("hidden-md hidden-lg", s.space2)}
            >
            ...
            <Col xs={12} sm={12} md={7} lg={8} className={s.listDetailContent}>
              ...
              <Col
                ...
                md={10}
                lg={10}
                className={cx(s.noPadding, s.textOverFlow)}
              >
                <a target="_blank" href={"/rooms/" + listId + "/preview"}>
              ...
              <Col
                ...
                md={10}
                lg={10}
                className={cx(s.noPadding, s.spaceTop1)}
              >
              ...
              <Col
                ...
                md={10}
                lg={10}
                className={cx(s.noPadding, s.spaceTop2, s.space2)}
              >
                <ProgressBar
                ...
                <span className={s.labelText}>
                  <FormattedMessage {...messages.progressBarText1} />{" "}
              ...
              >
                {data.listingSteps?.step4 === "completed" &&
                  listPhotos.length > 0 && (
                    <span>
              ...
              {data &&
                data.isReady &&
                data.user.userBanStatus != 1 &&
                data.listApprovalStatus === "approved" && (
                  <PublishOption
                    listId={listId}
