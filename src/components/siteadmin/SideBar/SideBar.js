...
class SideBar extends Component {
  ...
  render() {
    ...
    let reviewManagementArray = [
      "/siteadmin/reviews",
      "/siteadmin/reviews/edit-review/",
      "/siteadmin/write-reviews",
    ];
    let adminManagementArray = [
      "/siteadmin/admin-users",
      "/siteadmin/admin-roles",
    ];
    let homePageArray = [
      ...
      <div>
        <div className={cx(s.mobileHeader, "visible-xs")}>
          ...
          <div>
            <Link
              to={""}
              onClick={() => adminLogout()}
              className={cx(s.logoutIconMobile, "visible-xs visible-sm")}
            >
              <div className={cx(s.logoutIcon, "logoutIconRTL")}>
                <img src={logoutIcon} />
              </div>
            </Link>
          </div>
        ...
        >
          <div className={cx({ [s.menuClose]: this.state.isOpen == 0 })}>
            <div
              className={cx(s.closeColor, "visible-xs", "closeColorAdminRTL")}
          ...
          <div className={cx("hidden-print", s.sidebarNavParent)}>
            <div className={cx(s.sideBarWelcome)}>
              <span>
                <FormattedMessage {...messages.welcomeAdmin} />
              </span>
            </div>
            ...
            <ul className={s.sidebarNav}>
              <li className={"visible-xs"}>
                ...
                >
                  <span>
                    <img
                      src={languageIcon}
                      className={cx(s.languageIcon, "languageIconRTLAdmin")}
                    />
                  </span>
              ...
              {validatePrivilege(1, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/settings/site",
                  })}
                >
                  <Link
              ...
              {isSuperAdmin && (
                <div>
                  <div
                    className={cx(
                      adminManagementArray.includes(location) ? [s.active] : ""
                    )}
                  >
                    <Button
                      bsStyle="link"
              ...
              {validatePrivilege(2, privileges) && (
                <li
                  className={cx({
                    [s.active]:
                      location === "/siteadmin/users" ||
                      location.startsWith("/siteadmin/profileView"),
                  })}
                >
                  <Link
                    to={"/siteadmin/users"}
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.manageUser} />
                    </span>
                  </Link>
                </li>
              )}
              ...
              {validatePrivilege(3, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/listings",
                  })}
                >
                  <Link
              ...
              {validatePrivilege(3, privileges) && listingApproval === "1" && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/listing-request",
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.listingApproval} />
                    </span>
                  </Link>
                </li>
              )}
              ...
              {validatePrivilege(4, privileges) && (
                <li
                  className={cx({
                    [s.active]:
                      location === "/siteadmin/reservations" ||
                      location.startsWith("/siteadmin/viewreservation/"),
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.manageReservations} />
                    </span>
                  </Link>
                </li>
              )}
              ...
              {validatePrivilege(5, privileges) && (
                <li
                  className={cx({
                    [s.active]:
                      location === "/siteadmin/user-reviews" ||
                      location.startsWith("/siteadmin/management-reviews/"),
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.reviewManagement} />
                    </span>
                  </Link>
                </li>
              )}
              {validatePrivilege(6, privileges) && (
                <div>
                  <div
                    className={cx({
                      [s.active]:
                        reviewManagementArray.includes(location) ||
                        location.startsWith("/siteadmin/reviews/edit-review/"),
                    })}
                  >
                    <Button
                      bsStyle="link"
                    ...
                    >
                      ...
                      <span className={s.disPlayTabelCell}>
                        <FormattedMessage {...messages.adminReviews} />
                      </span>
                  ...
                  <Collapse in={this.state.adminReview} className={s.subMenu}>
                    <div>
                      <li
                        className={cx({
                          [s.active]: location.startsWith("/siteadmin/reviews"),
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.manageReviwes} />
                          </span>
                        </Link>
                      </li>
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/write-reviews",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.writeReviwes} />
                          </span>
                        </Link>
                      </li>
                    </div>
              ...
              {validatePrivilege(7, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/settings/servicefees",
                  })}
                >
                  <Link
              ...
              {validatePrivilege(8, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/document",
                  })}
                >
                  <Link
              ...
              {validatePrivilege(9, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/messages",
                  })}
                >
                  <Link
              ...
              {validatePrivilege(10, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/reportUser",
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.reportManagement} />
                    </span>
                  </Link>
                </li>
              )}
              ...
              {validatePrivilege(17, privileges) && (
                <li
                  className={cx({
                    [s.active]:
                      location === "/siteadmin/payout" ||
                      location.startsWith("/siteadmin/viewpayout/"),
                  })}
                >
                  <Link
                    to={"/siteadmin/payout"}
              ...
              {isSuperAdmin && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/currency",
                  })}
                >
                  <Link
              ...
              {validatePrivilege(11, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/settings/search",
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.searchSettings} />
                    </span>
                  </Link>
                </li>
              )}
              ...
              <li
                className={cx({
                  [s.active]: location === "/siteadmin/change/admin",
                })}
              >
                <Link
                ...
                >
                  ...
                  <span className={s.disPlayTabelCell}>
                    <FormattedMessage {...messages.changePasswordLabel} />
                  </span>
                </Link>
              </li>
                  ...
                  <div
                    className={cx({
                      [s.active]:
                        ...
                        ) || homePageArray.includes(location),
                    })}
                  >
                    <Button
                      bsStyle="link"
                    ...
                    >
                      ...
                      <span className={s.disPlayTabelCell}>
                        <FormattedMessage {...messages.homePageSettings} />
                      </span>
                      {this.state.home && (
                        <span className={s.disPlayTabelCell}>
                          <FontAwesome.FaAngleUp className={s.navigationIcon} />
                    ...
                    <div>
                      ...
                      {validatePrivilege(12, privileges) && (
                        <li
                          className={cx({
                            [s.active]:
                              location === "/siteadmin/home/footer-block",
                          })}
                        >
                          <Link
                      ...
                      {validatePrivilege(13, privileges) && (
                        <li
                          className={cx({
                            [s.active]:
                              location === "/siteadmin/popularlocation" ||
                              location.startsWith(
                                "/siteadmin/edit/popularlocation/"
                              ) ||
                              location.startsWith(
                        ...
                        >
                          ...
                          >
                            ...
                            <span className={s.disPlayTabelCell}>
                              <FormattedMessage
                                {...messages.managePopularLocations}
                              />
                            </span>
                          </Link>
                        </li>
                      ...
                      {validatePrivilege(12, privileges) && (
                        <li
                          className={cx({
                            [s.active]:
                              location === "/siteadmin/home/static-info-block",
                          })}
                        >
                          <Link
                          ...
                          >
                            ...
                            <span className={s.disPlayTabelCell}>
                              <FormattedMessage {...messages.staticInfoBlock} />
                            </span>
                          </Link>
                        </li>
                      )}
                      {validatePrivilege(12, privileges) && (
                        ...
                        >
                          ...
                          >
                            ...
                            <span className={s.disPlayTabelCell}>
                              <FormattedMessage {...messages.homeBannerLabel} />
                            </span>
                          </Link>
                        </li>
                      )}
              ...
              {validatePrivilege(18, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/static-block",
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.sideMenu} />
                    </span>
                  </Link>
                </li>
              )}
              {validatePrivilege(19, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/categorys",
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.adminCategory} />
                    </span>
                  </Link>
                </li>
              )}
              {validatePrivilege(19, privileges) && (
                <li
                  className={cx({
                    [s.active]: location === "/siteadmin/subCategory",
                  })}
                >
                  <Link
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className={s.disPlayTabelCell}>
                        <FormattedMessage {...messages.whyBecomeHostPage} />
                      </span>
                      {this.state.whyHost && (
                        <span className={s.disPlayTabelCell}>
                          <FontAwesome.FaAngleUp className={s.navigationIcon} />
                  ...
                  <Collapse in={this.state.whyHost} className={s.subMenu}>
                    <div>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block1",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 1
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block2",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 2
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block3",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 3
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block4",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 4
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block5",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 5
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block6",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 6
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/whyHost/Block7",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.blockLabel} /> 7
                          </span>
                        </Link>
                      </li>
                    </div>
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className={s.disPlayTabelCell}>
                        <FormattedMessage {...messages.listSettingStep} />
                        #1
                      </span>
                      {this.state.step1 && (
                        <span className={s.disPlayTabelCell}>
                  ...
                  <Collapse in={this.state.step1} className={s.subMenu}>
                    <div>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/1",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/2",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.personCapacity} />
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/3",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.houseTypeLabel} />
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/4",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.buildingSize} />
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/5",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.bedRoomsLabel} />
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/6",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/7",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.bedTypeLabel} />
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/8",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/9",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/10",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/11",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/12",
                        })}
                      >
                        <Link
                ...
                <div>
                  ...
                  <Collapse in={this.state.step3} className={s.subMenu}>
                    <div>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/13",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/14",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/15",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/16",
                        })}
                      >
                        <Link
                        ...
                        >
                          ...
                          <span className={s.disPlayTabelCell}>
                            <FormattedMessage {...messages.bookingNoticeTime} />
                          </span>
                        </Link>
                      </li>
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/18",
                        })}
                      >
                        <Link
                      ...
                      <li
                        className={cx({
                          [s.active]: location === "/siteadmin/listsettings/19",
                        })}
                      >
                        <Link
              ...
              {validatePrivilege(15, privileges) && (
                <li
                  className={cx({
                    [s.active]:
                      location === "/siteadmin/content-management" ||
                      location.startsWith("/siteadmin/edit/page/") ||
                      location.startsWith("/siteadmin/page/add"),
                  })}
                >
                  <Link
                  ...
                  >
                    ...
                    <span className={s.disPlayTabelCell}>
                      <FormattedMessage {...messages.contentManagementLabel} />
                    </span>
                  </Link>
                </li>
              )}
              {validatePrivilege(15, privileges) && (
                <li
                  className={cx({
                    [s.active]:
                      location === "/siteadmin/staticpage/management" ||
                      location.startsWith("/siteadmin/edit/staticpage/"),
                  })}
                >
                  <Link
...
const mapState = (state) => ({
  ...
  privileges:
    state.adminPrevileges.privileges &&
    state.adminPrevileges.privileges.privileges,
