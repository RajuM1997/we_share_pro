...
import {
  startSubCategoryUploaderLoader,
  doUploadSubCategory,
  doRemoveSubCategory,
} from "../../../../actions/siteadmin/manageSubCategoryImage";
//Message
...
class Dropzone extends Component {
  static propTypes = {
    doUploadSubCategory: PropTypes.any.isRequired,
    doRemoveSubCategory: PropTypes.any.isRequired,
    startSubCategoryUploaderLoader: PropTypes.any.isRequired,
  };
  ...
  async success(file, fromServer) {
    const { doUploadSubCategory, data, change } = this.props;
    let fileName = fromServer.file.filename;
    let oldPicture = data.image != null ? data.image : null;
    let filePath = fromServer.file.path;
    let image = fileName;
    doUploadSubCategory(image, filePath, oldPicture, data.id);
    await change("SubEditCategory", "image", fileName);
  }
