        ...
        <Row className={s.landingContainer}>
          <Col xs={12} sm={7} md={7} lg={7} className={s.landingContent}>
            <h3 className={cx(s.landingContentTitle, s.space5)}>
              <FormattedMessage {...messages.reviewGuestBookTitle} />
            </h3>
            <p className={cx(s.landingStep3, s.space3)}>
              <span>
                <FormattedMessage {...messages.reviewGuestBookDescription} />
              </span>
            </p>
                  ...
                  <FormGroup className={s.formGroup}>
                    ...
                    >
                      ...
                      <Button
                        ...
                        onClick={() => nextPage("advance-notice")}
                      >
...
export default injectIntl(
  withStyles(s, bt)(connect(mapState, mapDispatch)(ReviewGuestBook))
);
