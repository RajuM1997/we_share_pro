...
import s from "./AddFieldManagement.css";
...
class AddFieldManagement extends React.Component {
  static propTypes = {
...
export default injectIntl(
  withStyles(s, bt)(connect(mapState, mapDispatch)(AddFieldManagement))
);
