...
const messages = defineMessages({
  ...
  descriptionInfo: {
    ...
    defaultMessage:
      "Visiting family or friends? Sight seeing? This helps your host plan for your trip.",
  ...
  stepTwoFlow: {
    id: "app.stepTwoFlow",
    defaultMessage:
      "Stay in control with app. You have full control of your availability, rates and rules. You can, block dates, set check-in times and manage your own communications directly with your guests through the system.",
    description: "Step 2",
  },
  stepThreeFlow: {
  ...
  strictTwo: {
    id: "app.strictTwo",
    defaultMessage:
      "If the guest cancels less than 7 days in advance, the remaining nights are not refunded.",
    description: "Moderate",
  },
  strictThree: {
    id: "app.strictThree",
    defaultMessage:
      "If the guest arrives and decides to leave early, the remaining nights are not refunded.",
    description: "Moderate",
  },
  strictMonthsOne: {
