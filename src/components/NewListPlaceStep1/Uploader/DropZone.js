...
import {
  startCoverPhotoUploaderLoader,
  endCoverPhotoUploaderLoader,
} from "../../../actions/siteadmin/manageCoverPhoto";
import { maxUploadSize } from "../../../config";

class Dropzone extends Component {
  static propTypes = {
    startCoverPhotoUploaderLoader: PropTypes.any.isRequired,
    endCoverPhotoUploaderLoader: PropTypes.any.isRequired,
  };
  ...
  async success(file, fromServer) {
    const { doUploadCategory, change } = this.props;
    ...
    await change("AddCoverPhoto", "image", fileName);
  }
