...
// Helpers
import validateStep3 from "../../ListPlaceStep1/validateStep3";
...
import SyncCalendar from "../../ListPlaceStep1/SyncCalendar/SyncCalendar";
                    ...
                    <FormGroup className={s.formGroup}>
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => nextPage("min-max-nights")}
                        >
...
export default injectIntl(
  withStyles(s, bt)(connect(mapState, mapDispatch)(MaxDaysNotice))
);
