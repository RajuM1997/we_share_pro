...
import {
  startOfferUploaderLoader,
  endOfferUploaderLoader,
} from "../../../../actions/siteadmin/mangeOfferImage.js";
import { maxUploadSize } from "../../../../config";

class Dropzone extends Component {
  static propTypes = {
    startOfferUploaderLoader: PropTypes.any.isRequired,
    endOfferUploaderLoader: PropTypes.any.isRequired,
  };
  ...
  async success(file, fromServer) {
    const { doUploadOffer, change } = this.props;
    ...
    await change("AddOffer", "image", fileName);
  }

  addedfile(file, fromServer) {
    const { startOfferUploaderLoader, endOfferUploaderLoader } = this.props;
