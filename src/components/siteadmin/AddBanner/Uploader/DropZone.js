...
import {
  startHomeBannerUploaderLoader,
  endHomeBannerUploaderLoader,
} from "../../../../actions/siteadmin/manageBannerImage";
import { maxUploadSize } from "../../../../config";

class Dropzone extends Component {
  static propTypes = {
    startHomeBannerUploaderLoader: PropTypes.any.isRequired,
    endHomeBannerUploaderLoader: PropTypes.any.isRequired,
  };
  ...
  async success(file, fromServer) {
    ...
    await change("AddBanner", "image", fileName);
  }
