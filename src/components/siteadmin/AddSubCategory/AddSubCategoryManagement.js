...
import s from "./AddSubCategoryManagement.css";
...
class AddSubCategoryManagement extends React.Component {
  static propTypes = {
...
AddSubCategoryManagement = reduxForm({
  form: "AddSubCategory", // a unique name for this form
  validate,
})(AddSubCategoryManagement);
...
export default injectIntl(
  withStyles(s, bt)(connect(mapState, mapDispatch)(AddSubCategoryManagement))
);
