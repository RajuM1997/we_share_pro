  ...
  render() {
    ...
    return (
      <div>
        {type == "icon" && (
          <div
            className={cx(s.iconContainer, heartIcon, "heartIconRtl")}
        ...
        {type == "button" && (
          <div className={s.buttonContainer} onClick={this.iconAction}>
            {iconSelected && (
              <img
                src={heartIconFill}
                className={cx(s.wishListIcon, s.vtrMiddle)}
                alt={"Wishlist"}
              />
            )}
            {!iconSelected && (
            ...
            <span className={cx(s.buttonText, s.vtrBottom)}>
              {iconSelected ? (
                ...
                <FormattedMessage {...messages.wishListSave} />
              )}
            </span>
          </div>
        )}
