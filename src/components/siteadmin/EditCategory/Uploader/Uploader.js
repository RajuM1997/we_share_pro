...
import { doRemoveCategory } from "../../../../actions/siteadmin/manageCategoryImage";
...
class Uploader extends React.Component {
  ...
  render() {
    const { doRemoveCategory, categoryUploaderLoading, values } = this.props;
    let loading = true;
    if (values) {
      loading = false;
    }
            ...
            <div className={bt.picContainerMain}>
              <div className={bt.picContainer}>
                ...
                {!loading && values.image != null && (
                  <div
                    style={{
                      backgroundImage: `url(/images/category/medium_${values.image})`,
                    }}
                ...
                {!loading && values.image != null && (
                  <a
                    ...
                    onClick={() => doRemoveCategory(values.image, values.id)}
